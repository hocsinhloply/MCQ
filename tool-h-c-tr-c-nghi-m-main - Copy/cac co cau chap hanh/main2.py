...
print("Thuy_luc_khi_nen\n")
print("1-20: Press 1\n")
print("21-40: Press 2\n")
print("40-65: Press 3\n")
print("Dong_co_cam_bien\n")
print("1-50: Press 4\n")
print("51-100: Press 5\n")
print("101-169: Press 6\n")
print("FULL ? Press <FULL>")
...
# sheetName = "FULL"
test = pd.read_excel("trac_nghiem.xlsx", sheet_name=sheetName)
...
S = ['A', 'B', 'C', 'D']
image_question = [25, 26, 27, 28, 29, 30]
...
def displayNextQuestion():
    ...
    if button_next['text'] == 'Bắt đầu lại':
        ...
        if question_number in image_question and sheetName == "Nhóm 17":
